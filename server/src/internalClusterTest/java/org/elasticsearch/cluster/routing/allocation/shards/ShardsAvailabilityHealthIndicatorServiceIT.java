            ...
            public void clusterChanged(ClusterChangedEvent event) {
                states.add(
                    new RoutingNodesAndHealth(
                        ...
                        service.calculate(false, 1, new HealthInfo(Map.of(), DataStreamLifecycleHealthInfo.NO_DSL_ERRORS, Map.of(), FileSettingsService.FileSettingsHealthInfo.INITIAL_INACTIVE))
                    )
                );
            }
        };
