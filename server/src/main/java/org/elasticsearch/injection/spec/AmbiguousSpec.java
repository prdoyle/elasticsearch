 ...
 * It is not an error if some type attempts to inject a {@link ParameterModifier#COLLECTION collection};
 * that collection will simply contain all the objects of the requested type.
 *
 * <p>
