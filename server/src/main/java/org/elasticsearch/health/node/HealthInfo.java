...
import static org.elasticsearch.reservedstate.service.FileSettingsService.FileSettingsHealthInfo.INITIAL_INACTIVE;
...
public record HealthInfo(
    ...
    public static final HealthInfo EMPTY_HEALTH_INFO = new HealthInfo(Map.of(), NO_DSL_ERRORS, Map.of(), INITIAL_INACTIVE);
    ...
    public HealthInfo(StreamInput input) throws IOException {
        this(
            ...
            input.getTransportVersion().onOrAfter(TransportVersions.FILE_SETTINGS_HEALTH_INFO)? input.readOptionalWriteable(FileSettingsHealthInfo::new): INITIAL_INACTIVE
        );
    }
