...
public class HealthInfoCacheTests extends ESTestCase {
    ...
    public void testAddHealthInfo() {
        ...
        healthInfoCache.updateNodeHealth(node1.getId(), GREEN, latestDslHealthInfo, repoHealthInfo, FileSettingsHealthInfo.INITIAL_INACTIVE);
        healthInfoCache.updateNodeHealth(node2.getId(), RED, null, null, FileSettingsHealthInfo.INITIAL_INACTIVE);
        ...
        healthInfoCache.updateNodeHealth(node1.getId(), RED, null, null, FileSettingsHealthInfo.INITIAL_INACTIVE);
    ...
    public void testRemoveNodeFromTheCluster() {
        HealthInfoCache healthInfoCache = HealthInfoCache.create(clusterService);
        healthInfoCache.updateNodeHealth(node1.getId(), GREEN, null, null, FileSettingsHealthInfo.INITIAL_INACTIVE);
        DataStreamLifecycleHealthInfo latestDslHealthInfo = randomDslHealthInfo();
        var repoHealthInfo = randomRepoHealthInfo();
        healthInfoCache.updateNodeHealth(node2.getId(), RED, latestDslHealthInfo, repoHealthInfo, FileSettingsHealthInfo.INITIAL_INACTIVE);
    ...
    public void testNotAHealthNode() {
        HealthInfoCache healthInfoCache = HealthInfoCache.create(clusterService);
        healthInfoCache.updateNodeHealth(node1.getId(), GREEN, randomDslHealthInfo(), randomRepoHealthInfo(), FileSettingsHealthInfo.INITIAL_INACTIVE);
        healthInfoCache.updateNodeHealth(node2.getId(), RED, null, null, FileSettingsHealthInfo.INITIAL_INACTIVE);
