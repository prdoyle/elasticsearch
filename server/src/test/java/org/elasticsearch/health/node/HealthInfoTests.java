...
public class HealthInfoTests extends AbstractWireSerializingTestCase<HealthInfo> {
    ...
    protected HealthInfo createTestInstance() {
        ...
        return new HealthInfo(diskInfoByNode, randomBoolean() ? randomDslHealthInfo() : null, repositoriesInfoByNode, FileSettingsService.FileSettingsHealthInfo.INITIAL_INACTIVE);
    }
    ...
    public static HealthInfo mutateHealthInfo(HealthInfo originalHealthInfo) {
        ...
        return new HealthInfo(diskHealth, dslHealth, repoHealth, FileSettingsService.FileSettingsHealthInfo.INITIAL_INACTIVE);
    }
