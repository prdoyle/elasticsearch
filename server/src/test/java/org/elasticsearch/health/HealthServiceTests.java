...
public class HealthServiceTests extends ESTestCase {
    ...
    public void testThatIndicatorsGetHealthInfoData() throws Exception {
        ...
        HealthInfo healthInfo = new HealthInfo(diskHealthInfoMap, DataStreamLifecycleHealthInfo.NO_DSL_ERRORS, repoHealthInfoMap, FileSettingsService.FileSettingsHealthInfo.INITIAL_INACTIVE);
